...
def create_student(
    ...
    return curd.create_student(db, student)
...
def create_workshop(
    ...
    return curd.create_workshop(db, workshop)
...
def get_workshop(
    ...
    return curd.get_workshop(db, workshop_id)
...
def create_registration(
    ...
    return curd.create_registration(db, registration)
...
def get_student_workshops(
    ...
    return curd.get_student_workshops(db, student_id)
...
def get_workshop_students(
    ...
    return curd.get_workshop_students(db, workshop_id)
...
def cancel_registration(
    ...
    return curd.cancel_registration(db, registration_id)
